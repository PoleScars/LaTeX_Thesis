...
\newacronym{bmg}{BMG}{bulk metallic glass}
...
\newacronym{r}{$r$}{nucleus radius} %m
\newacronym{Rc}{$R_{c}$}{critical cooling rate} %K/s
\newacronym{RE}{RE}{rare earth elements}
