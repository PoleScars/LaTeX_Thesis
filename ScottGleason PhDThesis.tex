...
\subsection{Cylinder Casting}
\todo{New section - rewrite once have cylinder method down. Also make plate targets into their own section.}

Heat 700\degree~ stir, cool 385\degree, heat 650\degree~ stir, cool 385\degree, heat 650\degree~ stir, cool 450\degree~ wait 30 seconds, stir and cast.

\subsubsection{Gravity Casting}
For naturally cooled gravity casting the melt was manually poured into a prepared copper cylinder mould. The casting cavity diameter is $25.4~ mm$, with a depth of $60~ mm$, and no riser allowing for a casting volume of approximately $30~ cc$. The mould was prepared by cleaning with lint free paper, polishing with Brasso \textcopyright, and wiping clean again with the paper.

\subsubsection{Sectioning of Targets}
Once the master alloy cylinder was cast the top and bottom quarter of the casting was removed on an auto-band saw. This removed the inconsistencies due to the quick initial cooling of the pour, and feeding of the final melt. The remaining, consistent casting was then sectioned into targets on the same saw. 
...
\todo{Draft sentence to be worked into XRD section}
