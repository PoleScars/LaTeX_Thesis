...
%People
Professor Michael Ferry $-$ For his supervision and guidance throughout my project. 

Dr. Kevin Laws $-$ For his supervision and guidance throughout my project.

Dr. David Miskovic $-$ For training in metallurgical methods, lab assistance, and data analysis. 

Dr. Bulent Gun $-$ For training in metallurgical methods. 

Dr. George Yang $-$ For providing general lab training and assistance.

Dr. Yu Wang $-$ For \acrshort{xrd} training and assistance.

Dr. Simon Hager $-$ For \acrshort{sem} training and assistance.

Dr. Yin Yao $-$ For \acrshort{afm} and \acrshort{sem} training and assistance.

Bill Joe $-$ For nano-indentation training and assistance. 

Nicholas Hamilton $-$ For his assistance with \LaTeX{} typesetting, and various scripting programmes.

Patrick Conway $-$ For training in induction melting, and assistance with numerous other aspects of my project. 

Caitlin Healy $-$ 

Maria Yan $-$ For her help with statistical analysis of my data. 
...
Professor Charles Sorrell $-$ For his advice on effective research presentations.
...
\subsection{Depostion of Thin Films} \label{sec:DepositionOfFilms}
...
\section{Crystallization Pathways}
\subsection{XRD and Heated XRD}
