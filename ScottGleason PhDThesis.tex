...
\begin{figure}[htbp]
	...
	\caption{DSC trace of the 3mm \MgZnCa~ target plate casting. The trace shows clear endothermic troughs indicating \Tm~ and \Tl~, but no clear exothermal peaks which would indicate \gls{Tg} and \Tx~. This data suggest the casting is primary crystalline.}
