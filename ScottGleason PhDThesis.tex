...
As mentioned, the production of BMGs requires the alloys be rapidly quenched at a rate equal or better than their \Rc~ in order to avoid crystallisation. For bulk samples these cooling rates are achieved via solidifying the liquid BMG alloys onto copper heat sinks capable of extracting heat at the high rates required. The four standard production methods are: \todo{Diamond extracts heat several times faster than Cu. Could industrial diamond be used in BMG production?}
...
The initial work of Yu, et al. \cite{Yu2013} has found a modest increase in M for SMGs over BMGs of $5- 10\%$ for the ultrastable Zr$_{65}$Cu$_{27.5}$Al$_{7.5}$ system, indicating SMG may be able to better support compressive loads. \todo{Assuming this based on the definition.}
