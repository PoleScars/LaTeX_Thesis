...
\Gls{eds} analysis via \gls{sem} on the first five plates has shown (insert results here). 
...
\begin{table}[h]
	...
	\begin{tabular}{ l l l l l l l l l l }
		\toprule
		Composition & \acrshort{Tg} & \acrshort{Tx} & \acrshort{Tm} & \acrshort{Tl} & \acrshort{dT} & $T_{rg(m)}$ & $T_{rg(l)}$ & \acrshort{gfa} & Source \\ 
