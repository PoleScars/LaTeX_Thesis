...
A typical \MgZnCa~ target has an approximate hardness of 300HV0.3/15 or about 2.94 GPa (HV to MPa is given by HV $x~ 9.807 =$ MPa).

%single image
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.70\textwidth]{Re_VickersHardness.png}
	\caption{The vickers test shows the typical \MgZnCa~ targets have a hardness of about 300HV0.3/15.}
	\label{fig:TargetHV}
\end{figure}
