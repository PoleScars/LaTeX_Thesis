...
Cleaning and cutting of base constituent element ingots was accomplished with minimal notable issues. The Mg ingot darken and re-oxidised during cutting, requiring additional cleaning after cutting. Despite no observable changes with Zn ingot it too was cleaned after cutting. The more volatile Ca ingot was cleaned and cut by hand just before casting. This was because it re-oxidised within minutes.
...
\hl{Notes: EDS
Point and line scanning had incontinent results, and it was difficult to find a representative area. 
Initially concerned maps would be confused by topography, pores etc. But results were within error of ICP. This implies EDS can be a reliable non-destructive composition check. 
}
